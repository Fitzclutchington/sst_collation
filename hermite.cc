...
double
MonotCubicInterpolator::
evaluate(double x, double y_threshold, double x_threshold) const {
  ...
  if(fabs(xf2.second- xf1.second) > y_threshold || fabs(xf2.first - xf1.first) > x_threshold ){
    //printf("Threshold failed with xf2 = %f %f, xf1 %f %f\n",xf2.second,xf2.first,xf1.second, xf1.first);
    return NAN;
  }
